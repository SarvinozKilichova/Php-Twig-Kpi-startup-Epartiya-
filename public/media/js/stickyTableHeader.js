        ...
        var _createClass = function() {
            ...
            return _createClass(StickyTableHeader, null, [ {
                ...
                value: function($thead) {
                    ...
                    console.log("getOriginalCellWidths");
                }
            }, {
                ...
                value: function() {
                    ...
                    handler = function() {
                        var scrollPos = $win.scrollTop(), 
                        	scrollInsideTable = scrollPos+$topmenu > tableTopPos && scrollPos < tableBottomPos - headerHeight, 
                        	scrollAboveTable = scrollPos+$topmenu < tableTopPos, 
                        	scrollBelowTable = scrollPos > tableBottomPos - headerHeight;
