...
class Api
{
     ...
     * @param array    $params
     *
     * @var int|string $params ['type']
     * @var int|string $params ['id']
     * @var string     $params ['title']
     * @var string     $params ['description']
     * @var bool       $params ['input_massage_content']
     * @var int        $params ['message_text']
     * @var string     $params ['parse_mode']
     * @var string     $params ['thumb_url']
     *
     * @return Message
     */
     ...
     * @var int|string $params ['text']
     * @var string     $params ['show_alert']
     * @var string     $params ['url']
     * @var bool       $params ['cache_time']
     *
     * @return Message
     */
