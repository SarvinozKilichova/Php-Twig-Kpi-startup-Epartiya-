...
namespace Nette\Paynet;
use Nette;
use Event;
// use Application\Models\Settings;
// use Application\Models\Transaction;
use Nette\Paynet\Classes\Types\GenericParam;
use Nette\Paynet\Classes\Types\GetStatementResult;
use Nette\Paynet\Classes\Types\GetInformationResult;
use Nette\Paynet\Classes\Types\CancelTransactionResult;
use Nette\Paynet\Classes\Types\PerformTransactionResult;
use Nette\Paynet\Classes\Types\CancelTransactionArguments;
use Nette\Paynet\Classes\Types\CheckTransactionArguments;
use Nette\Paynet\Classes\Types\CheckTransactionResult;
use Nette\Paynet\Classes\Types\GenericArguments;
use Nette\Paynet\Classes\Types\GenericResult;
use Nette\Paynet\Classes\Types\GetInformationArguments;
use Nette\Paynet\Classes\Types\GetStatementArguments;
use Nette\Paynet\Classes\Types\PerformTransactionArguments;
use Nette\Paynet\Classes\Types\TransactionStatement;
...
class ProviderWebService {
	...
	public function __construct() {
	   	...
	   	// $this->smtp = new GetInformationResult();
