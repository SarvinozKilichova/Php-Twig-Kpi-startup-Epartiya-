...
use \Tx\Mailer\GenericParam;
use \Tx\Mailer\GetStatementResult;
use \Tx\Mailer\GetInformationResult;
use \Tx\Mailer\CancelTransactionResult;
use \Tx\Mailer\PerformTransactionResult;
use \Tx\Mailer\CancelTransactionArguments;
use \Tx\Mailer\CheckTransactionArguments;
use \Tx\Mailer\CheckTransactionResult;
use \Tx\Mailer\GenericArguments;
use \Tx\Mailer\GenericResult;
use \Tx\Mailer\GetInformationArguments;
use \Tx\Mailer\GetStatementArguments;
use \Tx\Mailer\PerformTransactionArguments;
use \Tx\Mailer\TransactionStatement;
...
class Mailer {
    ...
    public function __construct() {
        ...
        $this->password = "3mG@PtS8N8";
        $this->serviceId = "7620366";
